            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.receivers = new ArrayList<String>(_list32.size);
                for (int _i33 = 0; _i33 < _list32.size; ++_i33)
                {
                  String _elem34;
                  _elem34 = iprot.readString();
                  struct.receivers.add(_elem34);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.cc = new ArrayList<String>(_list35.size);
                for (int _i36 = 0; _i36 < _list35.size; ++_i36)
                {
                  String _elem37;
                  _elem37 = iprot.readString();
                  struct.cc.add(_elem37);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.bcc = new ArrayList<String>(_list38.size);
                for (int _i39 = 0; _i39 < _list38.size; ++_i39)
                {
                  String _elem40;
                  _elem40 = iprot.readString();
                  struct.bcc.add(_elem40);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.attachments = new ArrayList<String>(_list41.size);
                for (int _i42 = 0; _i42 < _list41.size; ++_i42)
                {
                  String _elem43;
                  _elem43 = iprot.readString();
                  struct.attachments.add(_elem43);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MailEntity struct) throws org.apache.thrift.TException {
      ...
      if (struct.receivers != null) {
        oprot.writeFieldBegin(RECEIVERS_FIELD_DESC);
        {
          ...
          for (String _iter44 : struct.receivers)
          {
  ...
  private static class MailEntityTupleScheme extends TupleScheme<MailEntity> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, MailEntity struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (String _iter48 : struct.receivers)
        {
      ...
      if (struct.isSetAttachments()) {
        {
          ...
          for (String _iter51 : struct.attachments)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, MailEntity struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.receivers = new ArrayList<String>(_list52.size);
        for (int _i53 = 0; _i53 < _list52.size; ++_i53)
        {
          String _elem54;
          _elem54 = iprot.readString();
          struct.receivers.add(_elem54);
        }
      }
      struct.setReceiversIsSet(true);
      struct.subject = iprot.readString();
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.cc = new ArrayList<String>(_list55.size);
          for (int _i56 = 0; _i56 < _list55.size; ++_i56)
          {
            String _elem57;
            _elem57 = iprot.readString();
            struct.cc.add(_elem57);
          }
        }
        struct.setCcIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.bcc = new ArrayList<String>(_list58.size);
          for (int _i59 = 0; _i59 < _list58.size; ++_i59)
          {
            String _elem60;
            _elem60 = iprot.readString();
            struct.bcc.add(_elem60);
          }
        }
        struct.setBccIsSet(true);
      }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.attachments = new ArrayList<String>(_list61.size);
          for (int _i62 = 0; _i62 < _list61.size; ++_i62)
          {
            String _elem63;
            _elem63 = iprot.readString();
            struct.attachments.add(_elem63);
          }
        }
        struct.setAttachmentsIsSet(true);
      }
