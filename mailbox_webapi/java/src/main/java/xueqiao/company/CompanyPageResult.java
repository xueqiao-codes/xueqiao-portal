            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultList = new ArrayList<CompanyEntry>(_list136.size);
                for (int _i137 = 0; _i137 < _list136.size; ++_i137)
                {
                  CompanyEntry _elem138;
                  _elem138 = new CompanyEntry();
                  _elem138.read(iprot);
                  struct.resultList.add(_elem138);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.resultList != null) {
        if (struct.isSetResultList()) {
          oprot.writeFieldBegin(RESULT_LIST_FIELD_DESC);
          {
            ...
            for (CompanyEntry _iter139 : struct.resultList)
            {
      ...
      if (struct.isSetResultList()) {
        {
          ...
          for (CompanyEntry _iter140 : struct.resultList)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.resultList = new ArrayList<CompanyEntry>(_list141.size);
          for (int _i142 = 0; _i142 < _list141.size; ++_i142)
          {
            CompanyEntry _elem143;
            _elem143 = new CompanyEntry();
            _elem143.read(iprot);
            struct.resultList.add(_elem143);
          }
        }
        struct.setResultListIsSet(true);
      }
