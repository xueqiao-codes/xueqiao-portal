            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.subscribeCommodityIds = new HashSet<Integer>(2*_set24.size);
                for (int _i25 = 0; _i25 < _set24.size; ++_i25)
                {
                  int _elem26;
                  _elem26 = iprot.readI32();
                  struct.subscribeCommodityIds.add(_elem26);
                }
                iprot.readSetEnd();
              }
      ...
      if (struct.subscribeCommodityIds != null) {
        if (struct.isSetSubscribeCommodityIds()) {
          oprot.writeFieldBegin(SUBSCRIBE_COMMODITY_IDS_FIELD_DESC);
          {
            ...
            for (int _iter27 : struct.subscribeCommodityIds)
            {
      ...
      if (struct.isSetSubscribeCommodityIds()) {
        {
          ...
          for (int _iter28 : struct.subscribeCommodityIds)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.subscribeCommodityIds = new HashSet<Integer>(2*_set29.size);
          for (int _i30 = 0; _i30 < _set29.size; ++_i30)
          {
            int _elem31;
            _elem31 = iprot.readI32();
            struct.subscribeCommodityIds.add(_elem31);
          }
        }
        struct.setSubscribeCommodityIdsIsSet(true);
      }
