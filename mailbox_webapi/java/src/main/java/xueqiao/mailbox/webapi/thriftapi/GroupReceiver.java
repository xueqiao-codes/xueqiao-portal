...
public class GroupReceiver implements org.apache.thrift.TBase<GroupReceiver, GroupReceiver._Fields>, java.io.Serializable, Cloneable, Comparable<GroupReceiver> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GroupReceiver");
  ...
  private static final org.apache.thrift.protocol.TField GROUP_CODE_FIELD_DESC = new org.apache.thrift.protocol.TField("groupCode", org.apache.thrift.protocol.TType.STRING, (short)2);
  ...
  static {
    schemes.put(StandardScheme.class, new GroupReceiverStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GroupReceiverTupleSchemeFactory());
  }
  ...
  private _Fields optionals[] = {_Fields.GROUP_ID,_Fields.GROUP_CODE,_Fields.GROUP_NAME,_Fields.COMPANY_ID};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GroupReceiver.class, metaDataMap);
  }
   ...
   */
  public GroupReceiver(GroupReceiver other) {
  ...
  public GroupReceiver deepCopy() {
    return new GroupReceiver(this);
  }
  ...
  public GroupReceiver setGroupId(long groupId) {
  ...
  public GroupReceiver setGroupCode(String groupCode) {
  ...
  public GroupReceiver setGroupName(String groupName) {
  ...
  public GroupReceiver setCompanyId(long companyId) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GroupReceiver)
      return this.equals((GroupReceiver)that);
    return false;
  }

  public boolean equals(GroupReceiver that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GroupReceiver other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GroupReceiver(");
    boolean first = true;
  ...
  private static class GroupReceiverStandardSchemeFactory implements SchemeFactory {
    public GroupReceiverStandardScheme getScheme() {
      return new GroupReceiverStandardScheme();
    }
  }

  private static class GroupReceiverStandardScheme extends StandardScheme<GroupReceiver> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GroupReceiver struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GroupReceiver struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class GroupReceiverTupleSchemeFactory implements SchemeFactory {
    public GroupReceiverTupleScheme getScheme() {
      return new GroupReceiverTupleScheme();
    }
  }

  private static class GroupReceiverTupleScheme extends TupleScheme<GroupReceiver> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GroupReceiver struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GroupReceiver struct) throws org.apache.thrift.TException {
