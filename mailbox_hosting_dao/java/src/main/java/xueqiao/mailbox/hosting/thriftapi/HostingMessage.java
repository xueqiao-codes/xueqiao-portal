...
public class HostingMessage implements org.apache.thrift.TBase<HostingMessage, HostingMessage._Fields>, java.io.Serializable, Cloneable, Comparable<HostingMessage> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("HostingMessage");

  private static final org.apache.thrift.protocol.TField HOSTING_MESSAGE_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("hostingMessageId", org.apache.thrift.protocol.TType.I64, (short)1);
  ...
  static {
    schemes.put(StandardScheme.class, new HostingMessageStandardSchemeFactory());
    schemes.put(TupleScheme.class, new HostingMessageTupleSchemeFactory());
  }

  public long hostingMessageId; // optional
  ...
  private static final int __HOSTINGMESSAGEID_ISSET_ID = 0;
  ...
  private _Fields optionals[] = {_Fields.HOSTING_MESSAGE_ID,_Fields.COMPANY_ID,_Fields.USER_ID,_Fields.MESSAGE_JOB_ID,_Fields.TYPE,_Fields.LEVEL,_Fields.TITLE,_Fields.SUMMARY,_Fields.CONTENT_FILE_NAME,_Fields.STATE,_Fields.CREATE_TIMESTAMP,_Fields.LAST_MODIFY_TIMESTAMP};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(HostingMessage.class, metaDataMap);
  }

  public HostingMessage() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public HostingMessage(HostingMessage other) {
    __isset_bitfield = other.__isset_bitfield;
    this.hostingMessageId = other.hostingMessageId;
  ...
  public HostingMessage deepCopy() {
    return new HostingMessage(this);
  }

  @Override
  public void clear() {
    setHostingMessageIdIsSet(false);
    this.hostingMessageId = 0;
  ...
  public long getHostingMessageId() {
    return this.hostingMessageId;
  }

  public HostingMessage setHostingMessageId(long hostingMessageId) {
    this.hostingMessageId = hostingMessageId;
    setHostingMessageIdIsSet(true);
    return this;
  }

  public void unsetHostingMessageId() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __HOSTINGMESSAGEID_ISSET_ID);
  }
  ...
  public boolean isSetHostingMessageId() {
    return EncodingUtils.testBit(__isset_bitfield, __HOSTINGMESSAGEID_ISSET_ID);
  }

  public void setHostingMessageIdIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __HOSTINGMESSAGEID_ISSET_ID, value);
  }
  ...
  public HostingMessage setCompanyId(long companyId) {
  ...
  public HostingMessage setUserId(long userId) {
    this.userId = userId;
    setUserIdIsSet(true);
    return this;
  }
  ...
  public HostingMessage setMessageJobId(long messageJobId) {
   ...
   * @see MType
   */
  public HostingMessage setType(MType type) {
    this.type = type;
    return this;
  }
   ...
   * @see MLevel
   */
  public HostingMessage setLevel(MLevel level) {
    this.level = level;
    return this;
  }
  ...
  public HostingMessage setTitle(String title) {
    this.title = title;
    return this;
  }
  ...
  public HostingMessage setSummary(String summary) {
  ...
  public HostingMessage setContentFileName(String contentFileName) {
   ...
   * @see MessageState
   */
  public HostingMessage setState(MessageState state) {
    this.state = state;
    return this;
  }
  ...
  public HostingMessage setCreateTimestamp(long createTimestamp) {
  ...
  public HostingMessage setLastModifyTimestamp(long lastModifyTimestamp) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case HOSTING_MESSAGE_ID:
      if (value == null) {
        ...
        setHostingMessageId((Long)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case HOSTING_MESSAGE_ID:
      return Long.valueOf(getHostingMessageId());
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof HostingMessage)
      return this.equals((HostingMessage)that);
    return false;
  }

  public boolean equals(HostingMessage that) {
    if (that == null)
      return false;
    ...
    if (this_present_hostingMessageId || that_present_hostingMessageId) {
      if (!(this_present_hostingMessageId && that_present_hostingMessageId))
        return false;
      if (this.hostingMessageId != that.hostingMessageId)
        return false;
    }
  ...
  @Override
  public int compareTo(HostingMessage other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("HostingMessage(");
    boolean first = true;
  ...
  private static class HostingMessageStandardSchemeFactory implements SchemeFactory {
    public HostingMessageStandardScheme getScheme() {
      return new HostingMessageStandardScheme();
    }
  }

  private static class HostingMessageStandardScheme extends StandardScheme<HostingMessage> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, HostingMessage struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // HOSTING_MESSAGE_ID
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.hostingMessageId = iprot.readI64();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HostingMessage struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.isSetHostingMessageId()) {
        oprot.writeFieldBegin(HOSTING_MESSAGE_ID_FIELD_DESC);
        oprot.writeI64(struct.hostingMessageId);
        oprot.writeFieldEnd();
      }
  ...
  private static class HostingMessageTupleSchemeFactory implements SchemeFactory {
    public HostingMessageTupleScheme getScheme() {
      return new HostingMessageTupleScheme();
    }
  }

  private static class HostingMessageTupleScheme extends TupleScheme<HostingMessage> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, HostingMessage struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, HostingMessage struct) throws org.apache.thrift.TException {
