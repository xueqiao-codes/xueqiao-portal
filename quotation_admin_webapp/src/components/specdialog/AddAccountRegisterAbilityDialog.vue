  ...
  >
    <div class="dialog-container">
      <div class="dialog-header">
        <div class="dialog-title">添加可订阅商品({{$config.QUOTATION_PLATFORM_ENV.ITEMS[platformEnv].label}})</div>
...
<script>
export default {
  props: ["isShow", "accountId", "platformEnv"],
  data() {
    return {
      // options
  ...
  methods: {
    ...
    reqCommodityTypeTree() {
      var that = this;
      var platformEnv = this.platformEnv//TechPlatformEnv.REAL;
