...
public class ContractServiceAsyncStub extends BaseStub { 
  ...
  public void send_updateSledContractStatus(int routeKey, int timeout, Set<Integer> sledContractIds, com.longsheng.xueqiao.contract.standard.thriftapi.ContractStatus newContractStatus) throws TException {
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
    ...
    SvrContainer.getInstance().sendRequest(
        create_updateSledContractStatusServiceCall(routeKey, timeout, platformArgs, sledContractIds, newContractStatus), new TRequestOption());
  }

  public void send_updateSledContractStatus(int routeKey, int timeout, Set<Integer> sledContractIds, com.longsheng.xueqiao.contract.standard.thriftapi.ContractStatus newContractStatus,TRequestOption requestOption) throws TException { 
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
    ...
    SvrContainer.getInstance().sendRequest(
        create_updateSledContractStatusServiceCall(routeKey, timeout, platformArgs, sledContractIds, newContractStatus), requestOption);
  }

  public long updateSledContractStatus(int routeKey, int timeout, Set<Integer> sledContractIds, com.longsheng.xueqiao.contract.standard.thriftapi.ContractStatus newContractStatus, IMethodCallback<ContractService.updateSledContractStatus_args, ContractService.updateSledContractStatus_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
    ...
    return SvrContainer.getInstance().sendRequest(
            create_updateSledContractStatusServiceCall(routeKey, timeout, platformArgs, sledContractIds, newContractStatus), callback);
  }

  public long add_updateSledContractStatusCall(AsyncCallRunner runner, int routeKey, int timeout, Set<Integer> sledContractIds, com.longsheng.xueqiao.contract.standard.thriftapi.ContractStatus newContractStatus, IMethodCallback<ContractService.updateSledContractStatus_args, ContractService.updateSledContractStatus_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_updateSledContractStatusServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs, Set<Integer> sledContractIds, com.longsheng.xueqiao.contract.standard.thriftapi.ContractStatus newContractStatus){
    TServiceCall serviceCall = new TServiceCall();
    if (!getPeerAddr().isEmpty()) {
      serviceCall.setChooseServiceIp(getPeerAddr());
    }
    ...
    serviceCall.setRouteKey(routeKey);
    serviceCall.setOneWay(false);
    ContractService.updateSledContractStatus_args request = new ContractService.updateSledContractStatus_args();
    request.setPlatformArgs(platformArgs);
    request.setSledContractIds(sledContractIds);
    request.setNewContractStatus(newContractStatus);
    serviceCall.setRequest(request);
    serviceCall.setMethodName("updateSledContractStatus");
    serviceCall.setTimeout(timeout);
    serviceCall.setResponse(ContractService.updateSledContractStatus_result.class);
    return serviceCall;
  }
  ...
  public void send_addSledCommodity(int routeKey, int timeout, com.longsheng.xueqiao.contract.standard.thriftapi.SledCommodity sledCommodity, String mappingCode) throws TException {
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
    ...
    SvrContainer.getInstance().sendRequest(
        create_addSledCommodityServiceCall(routeKey, timeout, platformArgs, sledCommodity, mappingCode), new TRequestOption());
  }

  public void send_addSledCommodity(int routeKey, int timeout, com.longsheng.xueqiao.contract.standard.thriftapi.SledCommodity sledCommodity, String mappingCode,TRequestOption requestOption) throws TException { 
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
    ...
    SvrContainer.getInstance().sendRequest(
        create_addSledCommodityServiceCall(routeKey, timeout, platformArgs, sledCommodity, mappingCode), requestOption);
  }

  public long addSledCommodity(int routeKey, int timeout, com.longsheng.xueqiao.contract.standard.thriftapi.SledCommodity sledCommodity, String mappingCode, IMethodCallback<ContractService.addSledCommodity_args, ContractService.addSledCommodity_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
    ...
    return SvrContainer.getInstance().sendRequest(
            create_addSledCommodityServiceCall(routeKey, timeout, platformArgs, sledCommodity, mappingCode), callback);
  }

  public long add_addSledCommodityCall(AsyncCallRunner runner, int routeKey, int timeout, com.longsheng.xueqiao.contract.standard.thriftapi.SledCommodity sledCommodity, String mappingCode, IMethodCallback<ContractService.addSledCommodity_args, ContractService.addSledCommodity_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_addSledCommodityServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs, com.longsheng.xueqiao.contract.standard.thriftapi.SledCommodity sledCommodity, String mappingCode){
    TServiceCall serviceCall = new TServiceCall();
    if (!getPeerAddr().isEmpty()) {
      serviceCall.setChooseServiceIp(getPeerAddr());
    }
  ...
  public long addSledExchangeMapping(int routeKey, int timeout, com.longsheng.xueqiao.contract.thriftapi.SledExchangeMapping sledExchangeMapping, IMethodCallback<ContractService.addSledExchangeMapping_args, ContractService.addSledExchangeMapping_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  public long add_addSledExchangeMappingCall(AsyncCallRunner runner, int routeKey, int timeout, com.longsheng.xueqiao.contract.thriftapi.SledExchangeMapping sledExchangeMapping, IMethodCallback<ContractService.addSledExchangeMapping_args, ContractService.addSledExchangeMapping_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_addSledExchangeMappingServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs, com.longsheng.xueqiao.contract.thriftapi.SledExchangeMapping sledExchangeMapping){
    ...
    serviceCall.setRouteKey(routeKey);
    serviceCall.setOneWay(false);
    ContractService.addSledExchangeMapping_args request = new ContractService.addSledExchangeMapping_args();
    request.setPlatformArgs(platformArgs);
    request.setSledExchangeMapping(sledExchangeMapping);
    serviceCall.setRequest(request);
    serviceCall.setMethodName("addSledExchangeMapping");
    serviceCall.setTimeout(timeout);
    serviceCall.setResponse(ContractService.addSledExchangeMapping_result.class);
    return serviceCall;
  }
  ...
  public long updateSledExchangeMapping(int routeKey, int timeout, com.longsheng.xueqiao.contract.thriftapi.SledExchangeMapping sledExchangeMapping, IMethodCallback<ContractService.updateSledExchangeMapping_args, ContractService.updateSledExchangeMapping_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  public long add_updateSledExchangeMappingCall(AsyncCallRunner runner, int routeKey, int timeout, com.longsheng.xueqiao.contract.thriftapi.SledExchangeMapping sledExchangeMapping, IMethodCallback<ContractService.updateSledExchangeMapping_args, ContractService.updateSledExchangeMapping_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_updateSledExchangeMappingServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs, com.longsheng.xueqiao.contract.thriftapi.SledExchangeMapping sledExchangeMapping){
    ...
    serviceCall.setRouteKey(routeKey);
    serviceCall.setOneWay(false);
    ContractService.updateSledExchangeMapping_args request = new ContractService.updateSledExchangeMapping_args();
    request.setPlatformArgs(platformArgs);
    request.setSledExchangeMapping(sledExchangeMapping);
    serviceCall.setRequest(request);
    serviceCall.setMethodName("updateSledExchangeMapping");
    serviceCall.setTimeout(timeout);
    serviceCall.setResponse(ContractService.updateSledExchangeMapping_result.class);
    return serviceCall;
  }
  ...
  public long reqSledExchangeMapping(int routeKey, int timeout, com.longsheng.xueqiao.contract.thriftapi.ReqSledExchangeMappingOption option, IMethodCallback<ContractService.reqSledExchangeMapping_args, ContractService.reqSledExchangeMapping_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  public long add_reqSledExchangeMappingCall(AsyncCallRunner runner, int routeKey, int timeout, com.longsheng.xueqiao.contract.thriftapi.ReqSledExchangeMappingOption option, IMethodCallback<ContractService.reqSledExchangeMapping_args, ContractService.reqSledExchangeMapping_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_reqSledExchangeMappingServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs, com.longsheng.xueqiao.contract.thriftapi.ReqSledExchangeMappingOption option){
    ...
    serviceCall.setRouteKey(routeKey);
    serviceCall.setOneWay(false);
    ContractService.reqSledExchangeMapping_args request = new ContractService.reqSledExchangeMapping_args();
    request.setPlatformArgs(platformArgs);
    request.setOption(option);
    serviceCall.setRequest(request);
    serviceCall.setMethodName("reqSledExchangeMapping");
    serviceCall.setTimeout(timeout);
    serviceCall.setResponse(ContractService.reqSledExchangeMapping_result.class);
    return serviceCall;
  }
  ...
  public long addSledCommodityTypeMapping(int routeKey, int timeout, com.longsheng.xueqiao.contract.thriftapi.SledCommodityTypeMapping sledCommodityTypeMapping, IMethodCallback<ContractService.addSledCommodityTypeMapping_args, ContractService.addSledCommodityTypeMapping_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  public long add_addSledCommodityTypeMappingCall(AsyncCallRunner runner, int routeKey, int timeout, com.longsheng.xueqiao.contract.thriftapi.SledCommodityTypeMapping sledCommodityTypeMapping, IMethodCallback<ContractService.addSledCommodityTypeMapping_args, ContractService.addSledCommodityTypeMapping_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_addSledCommodityTypeMappingServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs, com.longsheng.xueqiao.contract.thriftapi.SledCommodityTypeMapping sledCommodityTypeMapping){
    ...
    serviceCall.setRouteKey(routeKey);
    serviceCall.setOneWay(false);
    ContractService.addSledCommodityTypeMapping_args request = new ContractService.addSledCommodityTypeMapping_args();
    request.setPlatformArgs(platformArgs);
    request.setSledCommodityTypeMapping(sledCommodityTypeMapping);
    serviceCall.setRequest(request);
    serviceCall.setMethodName("addSledCommodityTypeMapping");
    serviceCall.setTimeout(timeout);
    serviceCall.setResponse(ContractService.addSledCommodityTypeMapping_result.class);
    return serviceCall;
  }
  ...
  public long updateSledCommodityTypeMapping(int routeKey, int timeout, com.longsheng.xueqiao.contract.thriftapi.SledCommodityTypeMapping sledCommodityTypeMapping, IMethodCallback<ContractService.updateSledCommodityTypeMapping_args, ContractService.updateSledCommodityTypeMapping_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  public long add_updateSledCommodityTypeMappingCall(AsyncCallRunner runner, int routeKey, int timeout, com.longsheng.xueqiao.contract.thriftapi.SledCommodityTypeMapping sledCommodityTypeMapping, IMethodCallback<ContractService.updateSledCommodityTypeMapping_args, ContractService.updateSledCommodityTypeMapping_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_updateSledCommodityTypeMappingServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs, com.longsheng.xueqiao.contract.thriftapi.SledCommodityTypeMapping sledCommodityTypeMapping){
    ...
    serviceCall.setRouteKey(routeKey);
    serviceCall.setOneWay(false);
    ContractService.updateSledCommodityTypeMapping_args request = new ContractService.updateSledCommodityTypeMapping_args();
    request.setPlatformArgs(platformArgs);
    request.setSledCommodityTypeMapping(sledCommodityTypeMapping);
    serviceCall.setRequest(request);
    serviceCall.setMethodName("updateSledCommodityTypeMapping");
    serviceCall.setTimeout(timeout);
    serviceCall.setResponse(ContractService.updateSledCommodityTypeMapping_result.class);
    return serviceCall;
  }
  ...
  public long reqSledCommodityTypeMapping(int routeKey, int timeout, com.longsheng.xueqiao.contract.thriftapi.ReqSledCommodityTypeMappingOption option, IMethodCallback<ContractService.reqSledCommodityTypeMapping_args, ContractService.reqSledCommodityTypeMapping_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  public long add_reqSledCommodityTypeMappingCall(AsyncCallRunner runner, int routeKey, int timeout, com.longsheng.xueqiao.contract.thriftapi.ReqSledCommodityTypeMappingOption option, IMethodCallback<ContractService.reqSledCommodityTypeMapping_args, ContractService.reqSledCommodityTypeMapping_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_reqSledCommodityTypeMappingServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs, com.longsheng.xueqiao.contract.thriftapi.ReqSledCommodityTypeMappingOption option){
    ...
    serviceCall.setRouteKey(routeKey);
    serviceCall.setOneWay(false);
    ContractService.reqSledCommodityTypeMapping_args request = new ContractService.reqSledCommodityTypeMapping_args();
    request.setPlatformArgs(platformArgs);
    request.setOption(option);
    serviceCall.setRequest(request);
    serviceCall.setMethodName("reqSledCommodityTypeMapping");
    serviceCall.setTimeout(timeout);
    serviceCall.setResponse(ContractService.reqSledCommodityTypeMapping_result.class);
    return serviceCall;
  }
  ...
  public long addCommoditySource(int routeKey, int timeout, com.longsheng.xueqiao.contract.thriftapi.CommoditySource commoditySource, IMethodCallback<ContractService.addCommoditySource_args, ContractService.addCommoditySource_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  public long add_addCommoditySourceCall(AsyncCallRunner runner, int routeKey, int timeout, com.longsheng.xueqiao.contract.thriftapi.CommoditySource commoditySource, IMethodCallback<ContractService.addCommoditySource_args, ContractService.addCommoditySource_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_addCommoditySourceServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs, com.longsheng.xueqiao.contract.thriftapi.CommoditySource commoditySource){
    ...
    serviceCall.setRouteKey(routeKey);
    serviceCall.setOneWay(false);
    ContractService.addCommoditySource_args request = new ContractService.addCommoditySource_args();
    request.setPlatformArgs(platformArgs);
    request.setCommoditySource(commoditySource);
    serviceCall.setRequest(request);
    serviceCall.setMethodName("addCommoditySource");
    serviceCall.setTimeout(timeout);
    serviceCall.setResponse(ContractService.addCommoditySource_result.class);
    return serviceCall;
  }
  ...
  public long updateCommoditySource(int routeKey, int timeout, com.longsheng.xueqiao.contract.thriftapi.CommoditySource commoditySource, IMethodCallback<ContractService.updateCommoditySource_args, ContractService.updateCommoditySource_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  public long add_updateCommoditySourceCall(AsyncCallRunner runner, int routeKey, int timeout, com.longsheng.xueqiao.contract.thriftapi.CommoditySource commoditySource, IMethodCallback<ContractService.updateCommoditySource_args, ContractService.updateCommoditySource_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_updateCommoditySourceServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs, com.longsheng.xueqiao.contract.thriftapi.CommoditySource commoditySource){
    ...
    serviceCall.setRouteKey(routeKey);
    serviceCall.setOneWay(false);
    ContractService.updateCommoditySource_args request = new ContractService.updateCommoditySource_args();
    request.setPlatformArgs(platformArgs);
    request.setCommoditySource(commoditySource);
    serviceCall.setRequest(request);
    serviceCall.setMethodName("updateCommoditySource");
    serviceCall.setTimeout(timeout);
    serviceCall.setResponse(ContractService.updateCommoditySource_result.class);
    return serviceCall;
  }
  ...
  public long reqCommoditySource(int routeKey, int timeout, com.longsheng.xueqiao.contract.thriftapi.ReqCommoditySourceOption option, IMethodCallback<ContractService.reqCommoditySource_args, ContractService.reqCommoditySource_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  public long add_reqCommoditySourceCall(AsyncCallRunner runner, int routeKey, int timeout, com.longsheng.xueqiao.contract.thriftapi.ReqCommoditySourceOption option, IMethodCallback<ContractService.reqCommoditySource_args, ContractService.reqCommoditySource_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_reqCommoditySourceServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs, com.longsheng.xueqiao.contract.thriftapi.ReqCommoditySourceOption option){
    ...
    serviceCall.setRouteKey(routeKey);
    serviceCall.setOneWay(false);
    ContractService.reqCommoditySource_args request = new ContractService.reqCommoditySource_args();
    request.setPlatformArgs(platformArgs);
    request.setOption(option);
    serviceCall.setRequest(request);
    serviceCall.setMethodName("reqCommoditySource");
    serviceCall.setTimeout(timeout);
    serviceCall.setResponse(ContractService.reqCommoditySource_result.class);
    return serviceCall;
  }
  ...
  public long addCommoditySourceAccount(int routeKey, int timeout, com.longsheng.xueqiao.contract.thriftapi.CommoditySourceAccount commoditySourceAccount, IMethodCallback<ContractService.addCommoditySourceAccount_args, ContractService.addCommoditySourceAccount_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_addCommoditySourceAccountServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs, com.longsheng.xueqiao.contract.thriftapi.CommoditySourceAccount commoditySourceAccount){
    ...
    serviceCall.setRouteKey(routeKey);
    serviceCall.setOneWay(false);
    ContractService.addCommoditySourceAccount_args request = new ContractService.addCommoditySourceAccount_args();
    request.setPlatformArgs(platformArgs);
    request.setCommoditySourceAccount(commoditySourceAccount);
    serviceCall.setRequest(request);
    serviceCall.setMethodName("addCommoditySourceAccount");
    serviceCall.setTimeout(timeout);
    serviceCall.setResponse(ContractService.addCommoditySourceAccount_result.class);
    return serviceCall;
  }
  ...
  public long updateCommoditySourceAccount(int routeKey, int timeout, com.longsheng.xueqiao.contract.thriftapi.CommoditySourceAccount commoditySourceAccount, IMethodCallback<ContractService.updateCommoditySourceAccount_args, ContractService.updateCommoditySourceAccount_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  public long add_updateCommoditySourceAccountCall(AsyncCallRunner runner, int routeKey, int timeout, com.longsheng.xueqiao.contract.thriftapi.CommoditySourceAccount commoditySourceAccount, IMethodCallback<ContractService.updateCommoditySourceAccount_args, ContractService.updateCommoditySourceAccount_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_updateCommoditySourceAccountServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs, com.longsheng.xueqiao.contract.thriftapi.CommoditySourceAccount commoditySourceAccount){
    ...
    serviceCall.setRouteKey(routeKey);
    serviceCall.setOneWay(false);
    ContractService.updateCommoditySourceAccount_args request = new ContractService.updateCommoditySourceAccount_args();
    request.setPlatformArgs(platformArgs);
    request.setCommoditySourceAccount(commoditySourceAccount);
    serviceCall.setRequest(request);
    serviceCall.setMethodName("updateCommoditySourceAccount");
    serviceCall.setTimeout(timeout);
    serviceCall.setResponse(ContractService.updateCommoditySourceAccount_result.class);
    return serviceCall;
  }
  ...
  public long reqCommoditySourceAccount(int routeKey, int timeout, com.longsheng.xueqiao.contract.thriftapi.ReqCommoditySourceAccountOption option, IMethodCallback<ContractService.reqCommoditySourceAccount_args, ContractService.reqCommoditySourceAccount_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_reqCommoditySourceAccountServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs, com.longsheng.xueqiao.contract.thriftapi.ReqCommoditySourceAccountOption option){
    ...
    serviceCall.setRouteKey(routeKey);
    serviceCall.setOneWay(false);
    ContractService.reqCommoditySourceAccount_args request = new ContractService.reqCommoditySourceAccount_args();
    request.setPlatformArgs(platformArgs);
    request.setOption(option);
    serviceCall.setRequest(request);
    serviceCall.setMethodName("reqCommoditySourceAccount");
    serviceCall.setTimeout(timeout);
    serviceCall.setResponse(ContractService.reqCommoditySourceAccount_result.class);
    return serviceCall;
  }
  ...
  public long addSledTradingSession(int routeKey, int timeout, com.longsheng.xueqiao.contract.thriftapi.SledTradingSession sledTradingSession, IMethodCallback<ContractService.addSledTradingSession_args, ContractService.addSledTradingSession_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  public long add_addSledTradingSessionCall(AsyncCallRunner runner, int routeKey, int timeout, com.longsheng.xueqiao.contract.thriftapi.SledTradingSession sledTradingSession, IMethodCallback<ContractService.addSledTradingSession_args, ContractService.addSledTradingSession_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_addSledTradingSessionServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs, com.longsheng.xueqiao.contract.thriftapi.SledTradingSession sledTradingSession){
    ...
    serviceCall.setRouteKey(routeKey);
    serviceCall.setOneWay(false);
    ContractService.addSledTradingSession_args request = new ContractService.addSledTradingSession_args();
    request.setPlatformArgs(platformArgs);
    request.setSledTradingSession(sledTradingSession);
    serviceCall.setRequest(request);
    serviceCall.setMethodName("addSledTradingSession");
    serviceCall.setTimeout(timeout);
    serviceCall.setResponse(ContractService.addSledTradingSession_result.class);
    return serviceCall;
  }
  ...
  public long updateSledTradingSession(int routeKey, int timeout, com.longsheng.xueqiao.contract.thriftapi.SledTradingSession sledTradingSession, IMethodCallback<ContractService.updateSledTradingSession_args, ContractService.updateSledTradingSession_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  public long add_updateSledTradingSessionCall(AsyncCallRunner runner, int routeKey, int timeout, com.longsheng.xueqiao.contract.thriftapi.SledTradingSession sledTradingSession, IMethodCallback<ContractService.updateSledTradingSession_args, ContractService.updateSledTradingSession_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_updateSledTradingSessionServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs, com.longsheng.xueqiao.contract.thriftapi.SledTradingSession sledTradingSession){
    ...
    serviceCall.setRouteKey(routeKey);
    serviceCall.setOneWay(false);
    ContractService.updateSledTradingSession_args request = new ContractService.updateSledTradingSession_args();
    request.setPlatformArgs(platformArgs);
    request.setSledTradingSession(sledTradingSession);
    serviceCall.setRequest(request);
    serviceCall.setMethodName("updateSledTradingSession");
    serviceCall.setTimeout(timeout);
    serviceCall.setResponse(ContractService.updateSledTradingSession_result.class);
    return serviceCall;
  }
  ...
  public long reqSledTradingSession(int routeKey, int timeout, com.longsheng.xueqiao.contract.thriftapi.ReqSledTradingSessionOption option, org.soldier.platform.page.IndexedPageOption pageOption, IMethodCallback<ContractService.reqSledTradingSession_args, ContractService.reqSledTradingSession_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  public long add_reqSledTradingSessionCall(AsyncCallRunner runner, int routeKey, int timeout, com.longsheng.xueqiao.contract.thriftapi.ReqSledTradingSessionOption option, org.soldier.platform.page.IndexedPageOption pageOption, IMethodCallback<ContractService.reqSledTradingSession_args, ContractService.reqSledTradingSession_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_reqSledTradingSessionServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs, com.longsheng.xueqiao.contract.thriftapi.ReqSledTradingSessionOption option, org.soldier.platform.page.IndexedPageOption pageOption){
    ...
    serviceCall.setRouteKey(routeKey);
    serviceCall.setOneWay(false);
    ContractService.reqSledTradingSession_args request = new ContractService.reqSledTradingSession_args();
    request.setPlatformArgs(platformArgs);
    request.setOption(option);
    ...
    serviceCall.setTimeout(timeout);
    serviceCall.setResponse(ContractService.reqSledTradingSession_result.class);
    return serviceCall;
  }
  ...
  public long removeSledTradingSession(int routeKey, int timeout, long tradeSessionId, IMethodCallback<ContractService.removeSledTradingSession_args, ContractService.removeSledTradingSession_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  public long add_removeSledTradingSessionCall(AsyncCallRunner runner, int routeKey, int timeout, long tradeSessionId, IMethodCallback<ContractService.removeSledTradingSession_args, ContractService.removeSledTradingSession_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_removeSledTradingSessionServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs, long tradeSessionId){
    ...
    serviceCall.setRouteKey(routeKey);
    serviceCall.setOneWay(false);
    ContractService.removeSledTradingSession_args request = new ContractService.removeSledTradingSession_args();
    request.setPlatformArgs(platformArgs);
    request.setTradeSessionId(tradeSessionId);
    serviceCall.setRequest(request);
    serviceCall.setMethodName("removeSledTradingSession");
    serviceCall.setTimeout(timeout);
    serviceCall.setResponse(ContractService.removeSledTradingSession_result.class);
    return serviceCall;
  }
