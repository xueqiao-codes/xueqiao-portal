...
public class QuotationAccountDaoAsyncStub extends BaseStub { 
  ...
  public void send_removeAccountCommodityRegisterAbility(int routeKey, int timeout, long accountId, int sledCommodityId) throws TException {
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
    ...
    SvrContainer.getInstance().sendRequest(
        create_removeAccountCommodityRegisterAbilityServiceCall(routeKey, timeout, platformArgs, accountId, sledCommodityId), new TRequestOption());
  }

  public void send_removeAccountCommodityRegisterAbility(int routeKey, int timeout, long accountId, int sledCommodityId,TRequestOption requestOption) throws TException { 
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
    ...
    SvrContainer.getInstance().sendRequest(
        create_removeAccountCommodityRegisterAbilityServiceCall(routeKey, timeout, platformArgs, accountId, sledCommodityId), requestOption);
  }

  public long removeAccountCommodityRegisterAbility(int routeKey, int timeout, long accountId, int sledCommodityId, IMethodCallback<QuotationAccountDao.removeAccountCommodityRegisterAbility_args, QuotationAccountDao.removeAccountCommodityRegisterAbility_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
    ...
    return SvrContainer.getInstance().sendRequest(
            create_removeAccountCommodityRegisterAbilityServiceCall(routeKey, timeout, platformArgs, accountId, sledCommodityId), callback);
  }

  public long add_removeAccountCommodityRegisterAbilityCall(AsyncCallRunner runner, int routeKey, int timeout, long accountId, int sledCommodityId, IMethodCallback<QuotationAccountDao.removeAccountCommodityRegisterAbility_args, QuotationAccountDao.removeAccountCommodityRegisterAbility_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_removeAccountCommodityRegisterAbilityServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs, long accountId, int sledCommodityId){
    TServiceCall serviceCall = new TServiceCall();
    if (!getPeerAddr().isEmpty()) {
      serviceCall.setChooseServiceIp(getPeerAddr());
    }
    ...
    request.setSledCommodityId(sledCommodityId);
    serviceCall.setRequest(request);
    serviceCall.setMethodName("deleteAccountCommodityRegisterAbility");
    serviceCall.setTimeout(timeout);
    serviceCall.setResponse(QuotationAccountDao.removeAccountCommodityRegisterAbility_result.class);
    return serviceCall;
  }

  public void send_reqQuotationAccountSubscribe(int routeKey, int timeout, xueqiao.quotation.account.thriftapi.ReqQuotationAccountSubscribeOption option, org.soldier.platform.page.IndexedPageOption pageOption) throws TException {
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
    ...
    SvrContainer.getInstance().sendRequest(
        create_reqQuotationAccountSubscribeServiceCall(routeKey, timeout, platformArgs, option, pageOption), new TRequestOption());
  }

  public void send_reqQuotationAccountSubscribe(int routeKey, int timeout, xueqiao.quotation.account.thriftapi.ReqQuotationAccountSubscribeOption option, org.soldier.platform.page.IndexedPageOption pageOption,TRequestOption requestOption) throws TException { 
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
    ...
    SvrContainer.getInstance().sendRequest(
        create_reqQuotationAccountSubscribeServiceCall(routeKey, timeout, platformArgs, option, pageOption), requestOption);
  }

  public long reqQuotationAccountSubscribe(int routeKey, int timeout, xueqiao.quotation.account.thriftapi.ReqQuotationAccountSubscribeOption option, org.soldier.platform.page.IndexedPageOption pageOption, IMethodCallback<QuotationAccountDao.reqQuotationAccountSubscribe_args, QuotationAccountDao.reqQuotationAccountSubscribe_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
    ...
    return SvrContainer.getInstance().sendRequest(
            create_reqQuotationAccountSubscribeServiceCall(routeKey, timeout, platformArgs, option, pageOption), callback);
  }

  public long add_reqQuotationAccountSubscribeCall(AsyncCallRunner runner, int routeKey, int timeout, xueqiao.quotation.account.thriftapi.ReqQuotationAccountSubscribeOption option, org.soldier.platform.page.IndexedPageOption pageOption, IMethodCallback<QuotationAccountDao.reqQuotationAccountSubscribe_args, QuotationAccountDao.reqQuotationAccountSubscribe_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_reqQuotationAccountSubscribeServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs, xueqiao.quotation.account.thriftapi.ReqQuotationAccountSubscribeOption option, org.soldier.platform.page.IndexedPageOption pageOption){
    TServiceCall serviceCall = new TServiceCall();
    if (!getPeerAddr().isEmpty()) {
      serviceCall.setChooseServiceIp(getPeerAddr());
    }
    ...
    serviceCall.setRouteKey(routeKey);
    serviceCall.setOneWay(false);
    QuotationAccountDao.reqQuotationAccountSubscribe_args request = new QuotationAccountDao.reqQuotationAccountSubscribe_args();
    request.setPlatformArgs(platformArgs);
    request.setOption(option);
    request.setPageOption(pageOption);
    serviceCall.setRequest(request);
    serviceCall.setMethodName("reqQuotationAccountSubscribe");
    serviceCall.setTimeout(timeout);
    serviceCall.setResponse(QuotationAccountDao.reqQuotationAccountSubscribe_result.class);
    return serviceCall;
  }
