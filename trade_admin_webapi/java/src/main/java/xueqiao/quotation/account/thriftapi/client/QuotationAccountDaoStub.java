...
public class QuotationAccountDaoStub extends BaseStub {
  ...
  public void  removeAccountCommodityRegisterAbility(long accountId, int sledCommodityId) throws org.soldier.platform.svr_platform.comm.ErrorInfo, TException{
    removeAccountCommodityRegisterAbility(accountId, sledCommodityId, new TStubOption().setCallTrace(Thread.currentThread().getStackTrace()[2]));
  }

  public void  removeAccountCommodityRegisterAbility(long accountId, int sledCommodityId,TStubOption platformStubOption) throws org.soldier.platform.svr_platform.comm.ErrorInfo, TException {
    InvokeMethodInfo invokeInfo = new InvokeMethodInfo("deleteAccountCommodityRegisterAbility").setRouteKey(platformStubOption.getRouteKey()).setTimeoutMs(platformStubOption.getTimeoutMs());
    if (platformStubOption.getCallTrace() != null) { 
      invokeInfo.setSourceCallTrace(platformStubOption.getCallTrace());
    } else {
      invokeInfo.setSourceCallTrace(Thread.currentThread().getStackTrace()[2]);
    ...
    @Override
    public Void call(TProtocol protocol, PlatformArgs platformArgs) throws ErrorInfo, TException {
      new QuotationAccountDao.Client(protocol).removeAccountCommodityRegisterAbility(platformArgs, accountId, sledCommodityId);
      return null;
      }
    }, invokeInfo);
  }

  public void  removeAccountCommodityRegisterAbility(int routeKey, int timeout,long accountId, int sledCommodityId)throws org.soldier.platform.svr_platform.comm.ErrorInfo, TException{
    removeAccountCommodityRegisterAbility(accountId, sledCommodityId, new TStubOption().setRouteKey(routeKey).setTimeoutMs(timeout).setCallTrace(Thread.currentThread().getStackTrace()[2]));
  }

  public xueqiao.quotation.account.thriftapi.QuotationAccountSubscribePage  reqQuotationAccountSubscribe(xueqiao.quotation.account.thriftapi.ReqQuotationAccountSubscribeOption option, org.soldier.platform.page.IndexedPageOption pageOption) throws org.soldier.platform.svr_platform.comm.ErrorInfo, TException{
    return reqQuotationAccountSubscribe(option, pageOption, new TStubOption().setCallTrace(Thread.currentThread().getStackTrace()[2]));
  }

  public xueqiao.quotation.account.thriftapi.QuotationAccountSubscribePage  reqQuotationAccountSubscribe(xueqiao.quotation.account.thriftapi.ReqQuotationAccountSubscribeOption option, org.soldier.platform.page.IndexedPageOption pageOption,TStubOption platformStubOption) throws org.soldier.platform.svr_platform.comm.ErrorInfo, TException {
    InvokeMethodInfo invokeInfo = new InvokeMethodInfo("reqQuotationAccountSubscribe").setRouteKey(platformStubOption.getRouteKey()).setTimeoutMs(platformStubOption.getTimeoutMs());
    if (platformStubOption.getCallTrace() != null) { 
      invokeInfo.setSourceCallTrace(platformStubOption.getCallTrace());
    } else {
      invokeInfo.setSourceCallTrace(Thread.currentThread().getStackTrace()[2]);
    }
    return super.runSync(new ThriftCallable<xueqiao.quotation.account.thriftapi.QuotationAccountSubscribePage>(){
    @Override
    public xueqiao.quotation.account.thriftapi.QuotationAccountSubscribePage call(TProtocol protocol, PlatformArgs platformArgs) throws ErrorInfo, TException {
      return new QuotationAccountDao.Client(protocol).reqQuotationAccountSubscribe(platformArgs, option, pageOption);
      }
    }, invokeInfo);
  }

  public xueqiao.quotation.account.thriftapi.QuotationAccountSubscribePage  reqQuotationAccountSubscribe(int routeKey, int timeout,xueqiao.quotation.account.thriftapi.ReqQuotationAccountSubscribeOption option, org.soldier.platform.page.IndexedPageOption pageOption)throws org.soldier.platform.svr_platform.comm.ErrorInfo, TException{
    return reqQuotationAccountSubscribe(option, pageOption, new TStubOption().setRouteKey(routeKey).setTimeoutMs(timeout).setCallTrace(Thread.currentThread().getStackTrace()[2]));
  }
