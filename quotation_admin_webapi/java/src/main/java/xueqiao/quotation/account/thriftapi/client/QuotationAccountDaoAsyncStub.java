...
public class QuotationAccountDaoAsyncStub extends BaseStub { 
  ...
  public void send_removeContractActiveRule(int routeKey, int timeout, int sledCommodityId, xueqiao.quotation.account.thriftapi.ContractActiveType activeType, String fixedCode) throws TException {
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
    ...
    SvrContainer.getInstance().sendRequest(
        create_removeContractActiveRuleServiceCall(routeKey, timeout, platformArgs, sledCommodityId, activeType, fixedCode), new TRequestOption());
  }

  public void send_removeContractActiveRule(int routeKey, int timeout, int sledCommodityId, xueqiao.quotation.account.thriftapi.ContractActiveType activeType, String fixedCode,TRequestOption requestOption) throws TException { 
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
    ...
    SvrContainer.getInstance().sendRequest(
        create_removeContractActiveRuleServiceCall(routeKey, timeout, platformArgs, sledCommodityId, activeType, fixedCode), requestOption);
  }

  public long removeContractActiveRule(int routeKey, int timeout, int sledCommodityId, xueqiao.quotation.account.thriftapi.ContractActiveType activeType, String fixedCode, IMethodCallback<QuotationAccountDao.removeContractActiveRule_args, QuotationAccountDao.removeContractActiveRule_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
    ...
    return SvrContainer.getInstance().sendRequest(
            create_removeContractActiveRuleServiceCall(routeKey, timeout, platformArgs, sledCommodityId, activeType, fixedCode), callback);
  }

  public long add_removeContractActiveRuleCall(AsyncCallRunner runner, int routeKey, int timeout, int sledCommodityId, xueqiao.quotation.account.thriftapi.ContractActiveType activeType, String fixedCode, IMethodCallback<QuotationAccountDao.removeContractActiveRule_args, QuotationAccountDao.removeContractActiveRule_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_removeContractActiveRuleServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs, int sledCommodityId, xueqiao.quotation.account.thriftapi.ContractActiveType activeType, String fixedCode){
    TServiceCall serviceCall = new TServiceCall();
    if (!getPeerAddr().isEmpty()) {
      serviceCall.setChooseServiceIp(getPeerAddr());
    }
  ...
  public void send_removeContractRegisterRule(int routeKey, int timeout, int sledCommodityId, xueqiao.quotation.account.thriftapi.QuotationPlatformEnv platformEnv, xueqiao.quotation.account.thriftapi.ContractActiveType activeType, String fixedCode) throws TException {
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
    ...
    SvrContainer.getInstance().sendRequest(
        create_removeContractRegisterRuleServiceCall(routeKey, timeout, platformArgs, sledCommodityId, platformEnv, activeType, fixedCode), new TRequestOption());
  }

  public void send_removeContractRegisterRule(int routeKey, int timeout, int sledCommodityId, xueqiao.quotation.account.thriftapi.QuotationPlatformEnv platformEnv, xueqiao.quotation.account.thriftapi.ContractActiveType activeType, String fixedCode,TRequestOption requestOption) throws TException { 
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
    ...
    SvrContainer.getInstance().sendRequest(
        create_removeContractRegisterRuleServiceCall(routeKey, timeout, platformArgs, sledCommodityId, platformEnv, activeType, fixedCode), requestOption);
  }

  public long removeContractRegisterRule(int routeKey, int timeout, int sledCommodityId, xueqiao.quotation.account.thriftapi.QuotationPlatformEnv platformEnv, xueqiao.quotation.account.thriftapi.ContractActiveType activeType, String fixedCode, IMethodCallback<QuotationAccountDao.removeContractRegisterRule_args, QuotationAccountDao.removeContractRegisterRule_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
    ...
    return SvrContainer.getInstance().sendRequest(
            create_removeContractRegisterRuleServiceCall(routeKey, timeout, platformArgs, sledCommodityId, platformEnv, activeType, fixedCode), callback);
  }
  ...
  protected TServiceCall create_removeContractRegisterRuleServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs, int sledCommodityId, xueqiao.quotation.account.thriftapi.QuotationPlatformEnv platformEnv, xueqiao.quotation.account.thriftapi.ContractActiveType activeType, String fixedCode){
    TServiceCall serviceCall = new TServiceCall();
    if (!getPeerAddr().isEmpty()) {
      serviceCall.setChooseServiceIp(getPeerAddr());
    }
  ...
  public void send_setCommodityRegisterOrderIndex(int routeKey, int timeout, int sledCommodityId, xueqiao.quotation.account.thriftapi.QuotationPlatformEnv platformEnv, int orderIndex, xueqiao.quotation.account.thriftapi.ContractActiveType activeType, String fixedCode) throws TException {
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  public void send_setCommodityRegisterOrderIndex(int routeKey, int timeout, int sledCommodityId, xueqiao.quotation.account.thriftapi.QuotationPlatformEnv platformEnv, int orderIndex, xueqiao.quotation.account.thriftapi.ContractActiveType activeType, String fixedCode,TRequestOption requestOption) throws TException { 
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  public long setCommodityRegisterOrderIndex(int routeKey, int timeout, int sledCommodityId, xueqiao.quotation.account.thriftapi.QuotationPlatformEnv platformEnv, int orderIndex, xueqiao.quotation.account.thriftapi.ContractActiveType activeType, String fixedCode, IMethodCallback<QuotationAccountDao.setCommodityRegisterOrderIndex_args, QuotationAccountDao.setCommodityRegisterOrderIndex_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_setCommodityRegisterOrderIndexServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs, int sledCommodityId, xueqiao.quotation.account.thriftapi.QuotationPlatformEnv platformEnv, int orderIndex, xueqiao.quotation.account.thriftapi.ContractActiveType activeType, String fixedCode){
    TServiceCall serviceCall = new TServiceCall();
    if (!getPeerAddr().isEmpty()) {
      serviceCall.setChooseServiceIp(getPeerAddr());
    }
