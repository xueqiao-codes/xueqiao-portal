...
public class ReqPlanningSubscribedInfoOption implements org.apache.thrift.TBase<ReqPlanningSubscribedInfoOption, ReqPlanningSubscribedInfoOption._Fields>, java.io.Serializable, Cloneable, Comparable<ReqPlanningSubscribedInfoOption> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ReqPlanningSubscribedInfoOption");
  ...
  static {
    schemes.put(StandardScheme.class, new ReqPlanningSubscribedInfoOptionStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ReqPlanningSubscribedInfoOptionTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ReqPlanningSubscribedInfoOption.class, metaDataMap);
  }

  public ReqPlanningSubscribedInfoOption() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public ReqPlanningSubscribedInfoOption(ReqPlanningSubscribedInfoOption other) {
  ...
  public ReqPlanningSubscribedInfoOption deepCopy() {
    return new ReqPlanningSubscribedInfoOption(this);
  }
   ...
   * @see com.longsheng.xueqiao.contract.standard.thriftapi.TechPlatformEnv
   */
  public ReqPlanningSubscribedInfoOption setPlatformEnv(com.longsheng.xueqiao.contract.standard.thriftapi.TechPlatformEnv platformEnv) {
  ...
  public ReqPlanningSubscribedInfoOption setCommodityNamePartical(String commodityNamePartical) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ReqPlanningSubscribedInfoOption)
      return this.equals((ReqPlanningSubscribedInfoOption)that);
    return false;
  }

  public boolean equals(ReqPlanningSubscribedInfoOption that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ReqPlanningSubscribedInfoOption other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ReqPlanningSubscribedInfoOption(");
    boolean first = true;
  ...
  private static class ReqPlanningSubscribedInfoOptionStandardSchemeFactory implements SchemeFactory {
    public ReqPlanningSubscribedInfoOptionStandardScheme getScheme() {
      return new ReqPlanningSubscribedInfoOptionStandardScheme();
    }
  }

  private static class ReqPlanningSubscribedInfoOptionStandardScheme extends StandardScheme<ReqPlanningSubscribedInfoOption> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ReqPlanningSubscribedInfoOption struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ReqPlanningSubscribedInfoOption struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ReqPlanningSubscribedInfoOptionTupleSchemeFactory implements SchemeFactory {
    public ReqPlanningSubscribedInfoOptionTupleScheme getScheme() {
      return new ReqPlanningSubscribedInfoOptionTupleScheme();
    }
  }

  private static class ReqPlanningSubscribedInfoOptionTupleScheme extends TupleScheme<ReqPlanningSubscribedInfoOption> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ReqPlanningSubscribedInfoOption struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ReqPlanningSubscribedInfoOption struct) throws org.apache.thrift.TException {
