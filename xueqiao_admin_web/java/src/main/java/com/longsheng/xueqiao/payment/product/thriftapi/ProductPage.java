...
public class ProductPage implements org.apache.thrift.TBase<ProductPage, ProductPage._Fields>, java.io.Serializable, Cloneable, Comparable<ProductPage> {
  ...
  public List<Product> page; // optional
  ...
  public ProductPage(ProductPage other) {
    ...
    if (other.isSetPage()) {
      List<Product> __this__page = new ArrayList<Product>(other.page.size());
      for (Product other_element : other.page) {
        __this__page.add(new Product(other_element));
      }
  ...
  public ProductPage setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<Product> getPageIterator() {
    return (this.page == null) ? null : this.page.iterator();
  }

  public void addToPage(Product elem) {
    if (this.page == null) {
      this.page = new ArrayList<Product>();
    }
    this.page.add(elem);
  }
  ...
  public ProductPage setPage(List<Product> page) {
    this.page = page;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.page = new ArrayList<Product>(_list44.size);
                for (int _i45 = 0; _i45 < _list44.size; ++_i45)
                {
                  Product _elem46;
                  _elem46 = new Product();
                  _elem46.read(iprot);
                  struct.page.add(_elem46);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.page != null) {
        if (struct.isSetPage()) {
          oprot.writeFieldBegin(PAGE_FIELD_DESC);
          {
            ...
            for (Product _iter47 : struct.page)
            {
              _iter47.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetPage()) {
        {
          ...
          for (Product _iter48 : struct.page)
          {
            _iter48.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.page = new ArrayList<Product>(_list49.size);
          for (int _i50 = 0; _i50 < _list49.size; ++_i50)
          {
            Product _elem51;
            _elem51 = new Product();
            _elem51.read(iprot);
            struct.page.add(_elem51);
          }
        }
        struct.setPageIsSet(true);
      }
