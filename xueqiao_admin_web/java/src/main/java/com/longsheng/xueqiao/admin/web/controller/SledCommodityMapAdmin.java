...
//	private int queryBrokerEntryListByPlatform_backup(int pageIndex, BrokerPlatform platform) throws TException {
//
//		if (mBrokerDaoServiceStub == null) {
//			mBrokerDaoServiceStub = new BrokerDaoServiceStub();
//		}
...
//			put("brokerEntryList", LocalBrokerEntry.transferToLocalBrokerEntryListWithPlatform(brokerEntryPage, platform.name()));
//		}
//
//		int totalPage = (brokerAccessEntryPage.getTotal() + PAGE_SIZE - 1) / PAGE_SIZE;
...
//		reqCommodityMapFileInfoOption.setBrokerEntryId(brokerEntryId);
//		reqCommodityMapFileInfoOption.setTechPlatform(TechPlatform.valueOf(MAPPING_PLATFORM));
