            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.page = new ArrayList<QuotationAccount>(_list196.size);
                for (int _i197 = 0; _i197 < _list196.size; ++_i197)
                {
                  QuotationAccount _elem198;
                  _elem198 = new QuotationAccount();
                  _elem198.read(iprot);
                  struct.page.add(_elem198);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.page != null) {
        if (struct.isSetPage()) {
          oprot.writeFieldBegin(PAGE_FIELD_DESC);
          {
            ...
            for (QuotationAccount _iter199 : struct.page)
            {
      ...
      if (struct.isSetPage()) {
        {
          ...
          for (QuotationAccount _iter200 : struct.page)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.page = new ArrayList<QuotationAccount>(_list201.size);
          for (int _i202 = 0; _i202 < _list201.size; ++_i202)
          {
            QuotationAccount _elem203;
            _elem203 = new QuotationAccount();
            _elem203.read(iprot);
            struct.page.add(_elem203);
          }
        }
        struct.setPageIsSet(true);
      }
