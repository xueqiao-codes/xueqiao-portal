...
public class QueryCompanyUserOption implements org.apache.thrift.TBase<QueryCompanyUserOption, QueryCompanyUserOption._Fields>, java.io.Serializable, Cloneable, Comparable<QueryCompanyUserOption> {
  ...
  private _Fields optionals[] = {_Fields.COMPANY_ID,_Fields.USER_ID,_Fields.USER_NAME,_Fields.STATUS,_Fields.PASSWORD};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.userId = new HashSet<Integer>(2*_set56.size);
                for (int _i57 = 0; _i57 < _set56.size; ++_i57)
                {
                  int _elem58;
                  _elem58 = iprot.readI32();
                  struct.userId.add(_elem58);
                }
                iprot.readSetEnd();
              }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.userId = new HashSet<Integer>(2*_set61.size);
          for (int _i62 = 0; _i62 < _set61.size; ++_i62)
          {
            int _elem63;
            _elem63 = iprot.readI32();
            struct.userId.add(_elem63);
          }
        }
        struct.setUserIdIsSet(true);
      }
